...
if(isset($_POST['submit'])){
    ...
    por un total de '.$_POST['dias'].' noches en una habitacion Doble de Q'.$_POST['precio'].'</p>'; 
            ...
            <div class="contenedor">
                ...
                <div class="cont_reserva">
                    <div class="reserva">
                        <div class="imgn">
                            <ul>
                                <li><img src="../img/dobles1.jpg" class="imagen" alt="imagen"></li>
                                <li><img src="../img/dobles2.jpg" class="imagen" alt="imagen"></li>
                                <li><img src="../img/dobles3.jpg" class="imagen" alt="imagen"></li>
                            </ul>
                        </div>
    
                        <div class="panel_reserva">
                            <h2>Q<span>600</span> Por Noche</h2>
                            <form action="" method="post">
                                ...
                                <br>
                                <input type="hidden" name="precio" id="precio" value="600">
