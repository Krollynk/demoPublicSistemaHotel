...
if(isset($_POST['submit'])){
    ...
    por un total de '.$_POST['dias'].' noches en una habitacion Individual de Q'.$_POST['precio'].'</p>'; 
            ...
            <div class="contenedor">
                ...
                <div class="cont_reserva">
                    <div class="reserva">
                        <div class="imgn">
                            <ul>
                                <li><img src="../img/simples2.jpg" class="imagen" alt="imagen"></li>
                                <li><img src="../img/simples3.jpg" class="imagen" alt="imagen"></li>
                                <li><img src="../img/simples4.jpg" class="imagen" alt="imagen"></li>
                            </ul>
                        </div>
    
                        <div class="panel_reserva">
                            <h2>Q<span>400</span> Por Noche</h2>
                            <form action="" method="post">
                                ...
                                <br>
                                <input type="hidden" name="precio" id="precio" value="400">
