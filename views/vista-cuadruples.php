...
if(isset($_POST['submit'])){
    ...
    por un total de '.$_POST['dias'].' noches en una habitacion Cuadruple de Q'.$_POST['precio'].'</p>'; 
...
<html lang="en">
    ...
    <body>
        <header>
            <nav class="nav">
                <a href="#main" class="logo">PLATINUM</a>
                <ul id="navegacion">
                ...
                <div class="cont_reserva">
                    <div class="reserva">
                        ...
                        <div class="panel_reserva">
                            <h2>Q<span>1000</span> Por Noche</h2>
                            <form action="" method="post">
                                ...
                                <br>
                                <input type="hidden" name="precio" id="precio" value="1000">
